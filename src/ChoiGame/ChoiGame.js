...
const Choigame = () => {
    const { players, Deck, isRevealed, onShuffle, onDraw, onReveal, onReset } = useContext(GameContext);
    return (
            ...
            <div className="div2">
                ...
                <div className="Content">
                    ...
                    <div className="btArea">
                        <button className="btShuffle" onClick={onShuffle}>Shuffle</button>
                        <button className="btDraw" onClick={onDraw}>Draw</button>
                        <button className="btReveal" onClick={onReveal}>Reveal</button>
                    </div>
                    <div className="bt">
                        <button className="btReset" onClick={onReset}>Reset</button>
                    </div>
                </div>
